...
INSERT INTO `chi_tiet_dv` VALUES (1,46,4),(2,59,3),(4,17,3),(5,20,2),(6,59,2),(8,17,3),(9,20,4),(10,20,4),(11,59,3),(13,59,2),(15,17,3),(16,20,NULL),(17,20,4),(36,20,NULL),(37,60,2),(38,60,3),(39,60,4),(40,60,1);
...
INSERT INTO `chi_tiet_thoi_gian_truc` VALUES (3,144,1,'2023-08-20',0),(4,121,2,'2023-08-20',0);
...
CREATE TABLE `hoa_don` (
  ...
  KEY `loai_thanh_toan_idx` (`loai_thanh_toan`),
  CONSTRAINT `HoaDon_PhieuDKy` FOREIGN KEY (`id_phieudky`) REFERENCES `phieu_dang_ky` (`id_phieudk`),
  CONSTRAINT `loai_thanh_toan` FOREIGN KEY (`loai_thanh_toan`) REFERENCES `loai_thanh_toan` (`id_loaiThanhToan`),
...
INSERT INTO `hoa_don` VALUES (1,'2023-08-08 00:00:00',200000,1,2,17),(2,NULL,30000,1,NULL,62);
...
CREATE TABLE `loai_thanh_toan` (
  `id_loaiThanhToan` int NOT NULL AUTO_INCREMENT,
  `ten_loai_thanh_toan` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`id_loaiThanhToan`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `thuoc` VALUES (1,'vitaminA','việt nam',25000,1,1),(5,'thuốc cảm','vn',20000,2,86),(6,'thuốc sốt','vn',123000,3,100),(12,'thuốc nóng','vn',45000,4,100),(15,'thuốc lạnh','vn',40000,5,100),(17,'VitaminB','VN',200000,1,100),(23,'Vitamin','vn',200000,4,123);
...
-- Dump completed on 2023-08-30 16:27:20
